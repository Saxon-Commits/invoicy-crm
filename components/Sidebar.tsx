...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, clearActiveDocuments, isDarkMode, setIsDarkMode }) => {
    const navItems = [
        { to: '/dashboard', label: 'Dashboard', iconPath: "M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 1.5m1-1.5l1 1.5m0 0l.5 1.5m-1.5-1.5l-1.5-1.5m0 0l1.5 1.5m-1.5-1.5l-1.5-1.5m-6.75 12.75h16.5" },
        { to: '/new', label: 'New Document', iconPath: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m3.75 9v6m3-3H9m1.5-12H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z", action: clearActiveDocuments },
        { to: '/files', label: 'Files', iconPath: "M3.75 9.75h16.5v11.25a2.25 2.25 0 01-2.25 2.25h-12a2.25 2.25 0 01-2.25-2.25V9.75zM3.75 9.75A2.25 2.25 0 001.5 7.5v-2.25A2.25 2.25 0 013.75 3h16.5a2.25 2.25 0 012.25 2.25v2.25a2.25 2.25 0 00-2.25 2.25H3.75z" },
        { to: '/crm', label: 'CRM', iconPath: "M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0z" },
        { to: '/productivity-hub', label: 'Productivity', iconPath: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.75 12l3 3m0 0l3-3m-3 3v-6m-1.5-9H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" },
        { to: '/projects', label: 'Projects', iconPath: "M2.25 12.75V12A2.25 2.25 0 014.5 9.75h15A2.25 2.25 0 0121.75 12v.75m-8.69-6.44l-2.12-2.12a1.5 1.5 0 00-1.061-.44H4.5A2.25 2.25 0 002.25 6v12a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9a2.25 2.25 0 00-2.25-2.25h-5.379a1.5 1.5 0 01-1.06-.44z" },
        { to: '/bills-and-expenses', label: 'Bills & Expenses', iconPath: "M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-1.5h5.25m-5.25 0h5.25m0 0h5.25m-5.25 0h5.25M3.75 6H7.5v3.75H3.75V6zM3.75 14.25H7.5v3.75H3.75v-3.75z" },
        { to: '/calendar', label: 'Calendar', iconPath: "M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18" },
    ];
    ...
    return (
        <>
            <div 
                ...
                aria-hidden="true"
            ></div>
            <aside className={`w-64 bg-slate-900 dark:bg-black p-4 flex-shrink-0 border-r border-slate-700 dark:border-zinc-800 flex flex-col fixed md:relative z-40 h-full transform transition-transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
                ...
                <div className="mt-auto">
                    ...
                    <div className="p-3 mb-2">
                        <div className="flex items-center justify-between">
                            <label htmlFor="darkModeToggle" className="text-slate-300 font-medium flex items-center gap-2">
                            ...
                            >
                                ...
                                <span className={`inline-flex items-center justify-center transform transition-transform duration-200 ease-in-out h-4 w-4 rounded-full bg-white shadow ${isDarkMode ? 'translate-x-6' : 'translate-x-1'}`}>
                                   {isDarkMode ? (
