...
const TemplateModern: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
            ...
            {showHeader && (
                <>
                    <header className="flex justify-between items-start pb-8 border-b-2 border-primary-500">
                        <div>
                            <h1 className="text-4xl font-bold text-primary-600 uppercase tracking-wider">{document.type}</h1>
                            {/* Fix: Changed docNumber to doc_number */}
                            <p className="text-slate-500 mt-1">{document.doc_number}</p>
                        </div>
                        <div className="text-right">
                            {companyInfo.logo && <img src={companyInfo.logo} alt="Company Logo" className="h-16 w-auto ml-auto mb-4 object-contain" />}
                    ...
                    <section className="grid grid-cols-2 gap-8 my-8">
                        ...
                        <div className="text-right">
                            ...
                            <p><strong className="text-slate-500">Issue Date:</strong> {document.issue_date}</p>
                            {/* Fix: Changed dueDate to due_date */}
                            <p><strong className="text-slate-500">Due Date:</strong> {document.due_date}</p>
                        </div>
                    </section>
                </>
            )}
                ...
                <footer className="mt-auto">
                    <section className="flex justify-end mt-8">
                        <div className="w-full sm:w-1/2 space-y-2 text-slate-600">
                            <div className="flex justify-between"><p>Subtotal</p><p>${document.subtotal.toFixed(2)}</p></div>
                            <div className="flex justify-between"><p>Tax ({document.tax}%)</p><p>${(document.subtotal * document.tax / 100).toFixed(2)}</p></div>
                            <div className="flex justify-between font-bold text-xl text-primary-600 border-t-2 border-primary-500 pt-2"><p>Total</p><p>${document.total.toFixed(2)}</p></div>
                        </div>
                    </section>

                    {document.notes && <div className="mt-10 pt-5 border-t border-slate-200"><h3 className="font-semibold text-slate-600">Notes</h3><p className="text-sm text-slate-500">{document.notes}</p></div>}
                </footer>
            )}
        </div>
    );
...
const TemplateClassic: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
        <div className="bg-white text-gray-900 p-4 sm:p-6 lg:p-10 font-serif h-full flex flex-col">
            {showHeader && (
                <>
                    <header className="text-center mb-10">
                        {companyInfo.logo && <img src={companyInfo.logo} alt="Company Logo" className="h-20 w-auto mx-auto mb-4 object-contain" />}
                    ...
                    <section className="flex justify-between mb-8 flex-col sm:flex-row gap-4">
                        <div>
                            ...
                            {/* Fix: Changed docNumber to doc_number */}
                            <p><span className="font-semibold text-gray-700">Number:</span> {document.doc_number}</p>
                            {/* Fix: Changed issueDate to issue_date */}
                            <p><span className="font-semibold text-gray-700">Date:</span> {document.issue_date}</p>
                            {/* Fix: Changed dueDate to due_date */}
                            <p><span className="font-semibold text-gray-700">Due:</span> {document.due_date}</p>
                        </div>
                ...
                <footer className="mt-auto">
                    <section className="flex justify-end mt-4">
                        <table className="w-full sm:w-1/2 md:w-1/3 text-gray-800">
                            <tbody>
                                <tr><td className="p-1 text-right">Subtotal:</td><td className="p-1 text-right">${document.subtotal.toFixed(2)}</td></tr>
                                <tr><td className="p-1 text-right">Tax ({document.tax}%):</td><td className="p-1 text-right">${(document.subtotal * document.tax / 100).toFixed(2)}</td></tr>
                                <tr className="font-bold text-lg"><td className="p-1 text-right border-t-2 border-gray-800">Total:</td><td className="p-1 text-right border-t-2 border-gray-800">${document.total.toFixed(2)}</td></tr>
                            </tbody>
                        </table>
                    </section>
                    {document.notes && <div className="mt-10 text-sm text-gray-600"><p>{document.notes}</p></div>}
                </footer>
            )}
        </div>
    );
...
const TemplateCreative: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
        <div className="bg-slate-900 text-white p-4 sm:p-6 lg:p-10 font-mono relative overflow-hidden h-full flex flex-col">
            ...
            {showHeader && (
                <>
                    <header className="flex justify-between items-center mb-12 relative z-10">
                        <div>
                             {companyInfo.logo && <img src={companyInfo.logo} alt="Company Logo" className="h-12 w-auto mb-2 object-contain" />}
                    ...
                    <section className="flex justify-between mb-12 relative z-10 flex-col sm:flex-row gap-4">
                        ...
                        <div className="sm:text-right">
                            {/* Fix: Changed issueDate to issue_date */}
                            <p className="text-cyan-400">Issue Date: <span className="text-white">{document.issue_date}</span></p>
                            {/* Fix: Changed dueDate to due_date */}
                            <p className="text-cyan-400">Due Date: <span className="text-white">{document.due_date}</span></p>
                        </div>
                    </section>
                </>
            )}
            ...
            <section className="relative z-10 flex-grow">
                <div className="border-y-2 border-cyan-400">
                    {items.map(item => (
                        <div key={item.id} className="flex justify-between items-center py-3 border-b border-slate-700 last:border-b-0 flex-col sm:flex-row text-center sm:text-left">
                            <div className="flex-1 mb-2 sm:mb-0">
                                <p className="font-bold text-lg text-white">{item.description}</p>
                                <p className="text-fuchsia-400 text-sm">{item.quantity} x ${item.price.toFixed(2)}</p>
                            </div>
                            <p className="text-xl font-bold text-white">${(item.quantity * item.price).toFixed(2)}</p>
                        </div>
                    ))}
                </div>
            </section>
                ...
                <footer className="mt-auto relative z-10">
                    <section className="flex justify-end mt-8">
                        <div className="w-full sm:w-3/5 md:w-2/5 space-y-2 text-lg">
                            <div className="flex justify-between"><p className="text-slate-400">Subtotal</p><p className="text-white">${document.subtotal.toFixed(2)}</p></div>
                            <div className="flex justify-between"><p className="text-slate-400">Tax ({document.tax}%)</p><p className="text-white">${(document.subtotal * document.tax / 100).toFixed(2)}</p></div>
                            <div className="flex justify-between font-bold text-3xl text-cyan-400 mt-2 pt-2 border-t-2 border-fuchsia-500"><p>Total</p><p>${document.total.toFixed(2)}</p></div>
                        </div>
                    </section>
                    {document.notes && <div className="mt-12 text-center text-slate-400"><p>// {document.notes}</p></div>}
                </footer>
            )}
        </div>
    );
...
const TemplateMinimalist: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
            ...
            {showHeader && (
                <>
                    <header className="flex justify-between items-start mb-16">
                        <div>
                            {companyInfo.logo && <img src={companyInfo.logo} alt="Company Logo" className="h-10 w-auto mb-2 object-contain" />}
                            <h2 className="text-xl font-normal tracking-widest uppercase text-gray-800">{companyInfo.name}</h2>
                        </div>
                        <div className="text-right">
                            <h1 className="text-4xl font-normal text-gray-400 uppercase tracking-wider">{document.type}</h1>
                            {/* Fix: Changed docNumber to doc_number */}
                ...
                <table className="w-full text-left">
                    <thead>
                        <tr className="border-b border-gray-300">
                            <th className="p-2 pb-3 font-normal text-xs uppercase text-gray-500 tracking-wider">Description</th>
                            <th className="p-2 pb-3 font-normal text-xs uppercase text-gray-500 tracking-wider text-center w-24">Qty</th>
                            <th className="p-2 pb-3 font-normal text-xs uppercase text-gray-500 tracking-wider text-right w-32">Unit Price</th>
                            <th className="p-2 pb-3 font-normal text-xs uppercase text-gray-500 tracking-wider text-right w-32">Total</th>
                        </tr>
                    </thead>
                    <tbody>
                        {items.map(item => (
                            <tr key={item.id} className="border-b border-gray-200">
                                ...
                                <td className="p-2 py-3 text-right text-gray-800">${(item.quantity * item.price).toFixed(2)}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                ...
                <footer className="mt-auto">
                    <section className="flex justify-end mt-8">
                        <div className="w-full sm:w-2/5 space-y-2 text-gray-600">
                            <div className="flex justify-between"><p>Subtotal</p><p>${document.subtotal.toFixed(2)}</p></div>
                            <div className="flex justify-between"><p>Tax ({document.tax}%)</p><p>${(document.subtotal * document.tax / 100).toFixed(2)}</p></div>
                            <div className="flex justify-between font-medium text-xl text-black border-t-2 border-black mt-2 pt-2"><p>Total</p><p>${document.total.toFixed(2)}</p></div>
                        </div>
                    </section>
                    {document.notes && <div className="mt-10 pt-5 border-t border-gray-200"><p className="text-sm text-gray-500">{document.notes}</p></div>}
                </footer>
            )}
        </div>
    );
...
const TemplateBold: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
                ...
                <>
                    <header className="bg-gray-900 text-white p-4 sm:p-6 lg:p-10">
                        <div className="flex justify-between items-center">
                            <div>
                                {companyInfo.logo && <img src={companyInfo.logo} alt="Company Logo" className="h-16 w-auto mb-2 object-contain" style={{ filter: 'brightness(0) invert(1)'}} />}
                    ...
                    <section className="grid grid-cols-2 gap-8 my-8 px-4 sm:px-6 lg:px-10">
                        <div>
                            <h3 className="text-sm font-bold uppercase text-gray-500 tracking-wider mb-2">Bill To:</h3>
                            <p className="font-bold text-lg text-gray-900">{document.customer?.name}</p>
                            <p className="text-gray-600">{document.customer?.address}</p>
                        </div>
                        <div className="text-right">
                            {/* Fix: Changed issueDate to issue_date */}
                            <p><strong className="text-gray-500">Issue Date:</strong> <span className="text-gray-800">{document.issue_date}</span></p>
                            {/* Fix: Changed dueDate to due_date */}
                            <p><strong className="text-gray-500">Due Date:</strong> <span className="text-gray-800">{document.due_date}</span></p>
                        </div>
                    </section>
                </>
            )}
                ...
                <table className="w-full text-left">
                    <thead className="border-b-2 border-gray-900">
                        <tr>
                            ...
                            <th className="p-2 pb-3 font-bold uppercase text-gray-800 text-right w-32">Unit Price</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                        {items.map(item => (
                            <tr key={item.id}>
                                ...
                                <td className="p-2 py-4 text-right font-semibold text-gray-800">${(item.quantity * item.price).toFixed(2)}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                ...
                <footer className="mt-auto px-4 sm:px-6 lg:px-10">
                    <section className="flex justify-end mt-8">
                        <div className="w-full sm:w-1/2 lg:w-2/5 py-4 text-gray-800">
                            <div className="flex justify-between"><p>Subtotal</p><p>${document.subtotal.toFixed(2)}</p></div>
                            <div className="flex justify-between mb-2"><p>Tax ({document.tax}%)</p><p>${(document.subtotal * document.tax / 100).toFixed(2)}</p></div>
                            <div className="flex justify-between font-bold text-xl text-white bg-gray-900 p-4 rounded-md"><p>Total</p><p>${document.total.toFixed(2)}</p></div>
                        </div>
                    </section>
                    {document.notes && <div className="mt-8 py-5 border-t border-gray-200"><p className="text-sm text-gray-600">{document.notes}</p></div>}
                </footer>
            )}
        </div>
    );
...
const TemplateRetro: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
            ...
            {showHeader && (
                <>
                    <header className="text-center mb-10 border-y-2 border-dashed border-[#93a1a1] py-4">
                        <h1 className="text-4xl font-bold text-[#cb4b16] tracking-wider">[ {companyInfo.name} ]</h1>
                    ...
                    <section className="flex justify-between mb-8 text-sm">
                        ...
                        <div className="text-right">
                            {/* Fix: Changed docNumber to doc_number */}
                            <p><span className="font-bold text-[#b58900]">{document.type.toUpperCase()} #:</span> {document.doc_number}</p>
                            {/* Fix: Changed issueDate to issue_date */}
                            <p><span className="font-bold text-[#b58900]">DATE:</span> {document.issue_date}</p>
                            {/* Fix: Changed dueDate to due_date */}
                            <p><span className="font-bold text-[#b58900]">DUE:</span> {document.due_date}</p>
                        </div>
                    </section>
                </>
            )}
                ...
                <footer className="mt-auto">
                    <section className="flex justify-end mt-4">
                        <div className="w-full sm:w-1/2 text-sm">
                            <div className="flex justify-between p-1 border-t border-dashed border-[#93a1a1]"><p>Subtotal:</p><p>${document.subtotal.toFixed(2)}</p></div>
                            <div className="flex justify-between p-1"><p>Tax ({document.tax}%):</p><p>${(document.subtotal * document.tax / 100).toFixed(2)}</p></div>
                            <div className="flex justify-between p-1 font-bold text-lg border-t-2 border-[#93a1a1] mt-1 text-[#cb4b16]"><p>TOTAL:</p><p>${document.total.toFixed(2)}</p></div>
                        </div>
                    </section>
                    {document.notes && <div className="mt-8 text-xs border-t border-dashed border-[#93a1a1] pt-4"><p>NOTES: {document.notes}</p></div>}
                </footer>
            )}
        </div>
    );
...
const TemplateCorporate: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
            ...
            {showHeader && (
                <>
                    <header className="flex justify-between items-start pb-6 mb-6 border-b-4 border-blue-700">
                        <div>
                             {companyInfo.logo && <img src={companyInfo.logo} alt="Company Logo" className="h-16 w-auto mb-4 object-contain" />}
                    ...
                    <section className="grid grid-cols-2 gap-8 my-4">
                        ...
                        <div className="text-right">
                            {/* Fix: Changed issueDate to issue_date */}
                            <p><strong className="text-gray-500">Issue Date:</strong> {document.issue_date}</p>
                            {/* Fix: Changed dueDate to due_date */}
                            <p><strong className="text-gray-500">Due Date:</strong> {document.due_date}</p>
                        </div>
                    </section>
                </>
            )}
                ...
                <footer className="mt-auto">
                    <section className="flex justify-end mt-8">
                        <div className="w-full sm:w-1/2 space-y-2 text-gray-700">
                            <div className="flex justify-between"><p>Subtotal</p><p>${document.subtotal.toFixed(2)}</p></div>
                            <div className="flex justify-between"><p>Tax ({document.tax}%)</p><p>${(document.subtotal * document.tax / 100).toFixed(2)}</p></div>
                            <div className="flex justify-between font-bold text-xl text-blue-700 border-t-2 border-blue-700 pt-2 mt-2"><p>Total Due</p><p>${document.total.toFixed(2)}</p></div>
                        </div>
                    </section>
                    {document.notes && <div className="mt-10 pt-5 border-t border-gray-200"><h3 className="font-semibold text-gray-700">Notes</h3><p className="text-sm text-gray-500">{document.notes}</p></div>}
                </footer>
            )}
        </div>
    );
...
const TemplateElegant: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
        <div className="bg-white text-gray-800 p-4 sm:p-6 lg:p-10 font-serif h-full flex flex-col">
            {showHeader && (
                <>
                    <header className="text-center mb-10">
                        {companyInfo.logo && <img src={companyInfo.logo} alt="Company Logo" className="h-16 w-auto mx-auto mb-4 object-contain" />}
                        <h1 className="text-4xl font-normal tracking-widest text-gray-800">{companyInfo.name.toUpperCase()}</h1>
                    </header>
                    ...
                    <section className="flex justify-between mb-10">
                        ...
                        <div className="text-right">
                            ...
                            {/* Fix: Changed issueDate to issue_date */}
                            <p className="mt-4"><span className="font-semibold text-gray-600">Date:</span> {document.issue_date}</p>
                            {/* Fix: Changed dueDate to due_date */}
                            <p><span className="font-semibold text-gray-600">Due:</span> {document.due_date}</p>
                        </div>
                    </section>
                </>
            )}
            <section className="flex-grow">
                <table className="w-full text-left">
                    <thead className="border-b-2 border-amber-500">
                        <tr>
                            <th className="p-2 pb-3 font-semibold uppercase text-sm text-gray-600">Description</th>
                ...
                <footer className="mt-auto">
                    <section className="flex justify-end mt-8">
                        <div className="w-full sm:w-1/2 space-y-2 text-gray-700">
                            <div className="flex justify-between"><p>Subtotal</p><p>${document.subtotal.toFixed(2)}</p></div>
                            <div className="flex justify-between"><p>Tax ({document.tax}%)</p><p>${(document.subtotal * document.tax / 100).toFixed(2)}</p></div>
                            <div className="flex justify-between font-bold text-xl text-amber-600 border-t-2 border-amber-500 pt-2 mt-2"><p>Total</p><p>${document.total.toFixed(2)}</p></div>
                        </div>
                    </section>
                </footer>
            )}
...
const TemplateFriendly: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
            ...
            {showHeader && (
                <header className="relative z-10">
                    <div className="flex justify-between items-center mb-10">
                        <div>
                            {companyInfo.logo && <img src={companyInfo.logo} alt="Company Logo" className="h-16 w-auto mb-2 object-contain" />}
                            <h2 className="text-2xl font-bold text-gray-800">{companyInfo.name}</h2>
                        </div>
                        <div className="text-right">
                     ...
                     <section className="bg-green-50 rounded-xl p-6 grid grid-cols-2 gap-8">
                        ...
                        <div className="text-right">
                            {/* Fix: Changed issueDate to issue_date */}
                            <p><strong className="text-green-800">Date:</strong> {document.issue_date}</p>
                            {/* Fix: Changed dueDate to due_date */}
                            <p><strong className="text-green-800">Due:</strong> {document.due_date}</p>
                        </div>
                    </section>
                </header>
            )}
                    ...
                    <tbody>
                        {items.map(item => (
                            <tr key={item.id}>
                                ...
                                <td className="p-2 py-3 border-b border-gray-100 text-right">${item.price.toFixed(2)}</td>
                                <td className="p-2 py-3 border-b border-gray-100 text-right font-semibold text-green-700">${(item.quantity * item.price).toFixed(2)}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                ...
                <footer className="mt-auto relative z-10">
                    <section className="flex justify-end mt-4">
                        <div className="w-full sm:w-1/2 p-6 bg-green-50 rounded-xl">
                            <div className="flex justify-between text-gray-700"><p>Subtotal</p><p>${document.subtotal.toFixed(2)}</p></div>
                            <div className="flex justify-between text-gray-700 mt-2"><p>Tax ({document.tax}%)</p><p>${(document.subtotal * document.tax / 100).toFixed(2)}</p></div>
                            <div className="flex justify-between font-bold text-2xl text-green-700 pt-3 mt-3 border-t-2 border-green-200"><p>Amount Due</p><p>${document.total.toFixed(2)}</p></div>
                        </div>
                    </section>
                </footer>
            )}
...
const TemplateTechnical: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
        <div className="bg-white text-gray-800 p-4 sm:p-6 lg:p-10 font-mono h-full flex flex-col text-sm">
            {showHeader && (
                <>
                    <header className="mb-8">
                        <p><span className="text-sky-600">FROM:</span> {companyInfo.name} &lt;{companyInfo.email}&gt;</p>
                        <p><span className="text-sky-600">TO:</span> {document.customer?.name} &lt;{document.customer?.email}&gt;</p>
                        {/* Fix: Changed docNumber to doc_number */}
                        <p className="mt-4"><span className="text-sky-600">SUBJECT:</span> {document.type} #{document.doc_number}</p>
                        {/* Fix: Changed issueDate to issue_date */}
                        <p><span className="text-sky-600">DATE:</span> {document.issue_date}</p>
                        {/* Fix: Changed dueDate to due_date */}
                        <p><span className="text-sky-600">DUE:</span> {document.due_date}</p>
                    </header>
                ...
                <footer className="mt-auto">
                    ...
                    <section className="flex justify-end mt-4">
                        <div className="w-full sm:w-1/2">
                            <p className="flex justify-between"><span>SUBTOTAL</span> <span>${document.subtotal.toFixed(2)}</span></p>
                            <p className="flex justify-between"><span>TAX ({document.tax}%)</span> <span>${(document.subtotal * document.tax / 100).toFixed(2)}</span></p>
                            <p className="flex justify-between font-bold text-lg mt-2 border-t border-gray-800 pt-1"><span>TOTAL</span> <span>${document.total.toFixed(2)}</span></p>
                        </div>
                    </section>
                     {document.notes && <div className="mt-8 text-xs text-gray-500"><p>// {document.notes}</p></div>}
                </footer>
            )}
        </div>
    );
...
const TemplateEarthy: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
            ...
            {showHeader && (
                <>
                    ...
                    <section className="grid grid-cols-2 gap-8 my-4">
                        ...
                        <div className="text-right">
                            {/* Fix: Changed issueDate to issue_date */}
                            <p><strong className="text-stone-600">Issued:</strong> {document.issue_date}</p>
                            {/* Fix: Changed dueDate to due_date */}
                            <p><strong className="text-stone-600">Due:</strong> {document.due_date}</p>
                        </div>
                    </section>
                </>
            )}
                    ...
                    <tbody className="divide-y divide-emerald-200">
                        {items.map(item => (
                            <tr key={item.id}>
                                ...
                                <td className="p-2 py-3 text-right font-medium">${(item.quantity * item.price).toFixed(2)}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                 ...
                 <footer className="mt-auto">
                    <section className="flex justify-end mt-8">
                        <div className="w-full sm:w-1/2 space-y-2 text-stone-700">
                            <div className="flex justify-between"><p>Subtotal</p><p>${document.subtotal.toFixed(2)}</p></div>
                            <div className="flex justify-between"><p>Tax ({document.tax}%)</p><p>${(document.subtotal * document.tax / 100).toFixed(2)}</p></div>
                            <div className="flex justify-between font-bold text-xl text-emerald-900 border-t-2 border-emerald-800 pt-2 mt-2"><p>Total</p><p>${document.total.toFixed(2)}</p></div>
                        </div>
                    </section>
                </footer>
            )}
...
const TemplateSwiss: React.FC<ExtendedPreviewProps> = ({ document, companyInfo, items, showHeader, showFooter }) => {
    return (
                ...
                <>
                    <header className="grid grid-cols-3 gap-8 items-start mb-16">
                        <div className="col-span-2">
                             {companyInfo.logo && <img src={companyInfo.logo} alt="Company Logo" className="h-12 w-auto mb-4 object-contain" />}
